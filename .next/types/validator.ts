...
// Validate ../../app/api/debug/openai/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/debug/openai">> = Specific
  const handler = {} as typeof import("../../app/api/debug/openai/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
